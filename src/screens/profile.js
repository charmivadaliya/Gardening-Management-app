...
import { View, Text, ImageBackground ,Image,TextInput, Pressable, Platform,Dimensions, ScrollView} from 'react-native';
        ...
        <Swiper style={{}} dotStyle={{height:15,width:15,borderRadius:8}} dotColor='#fff' activeDotStyle={{height:15,width:15,borderRadius:8}} activeDotColor='#94D440'>
            ...
            <ScrollView>
                <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                    ...
                    {/* <Image source={require('../assets/img/list.png')} style={{height:Platform.isPad === true ? 30 : 25,width:Platform.isPad === true ? 30 : 25}}></Image> */}
                    <Icon name='list' size={30} color='#EAFCD0'></Icon>
                </View>
